...
class ImagesListWidget extends StatefulWidget {
  ...
  ImagesListWidget(
      ...
      this.showCopyButton = false}); // Update constructor
...
class _ImagesListWidgetState extends State<ImagesListWidget> {
  late int currentIndex; // Change to late

  @override
  void initState() {
    super.initState();
    currentIndex =
        widget.initialIndex; // Initialize currentIndex with initialIndex
  }
  ...
  void _downloadImage() async {
    try {
      ...
      if (Theme.of(context).platform == TargetPlatform.android ||
        ...
        // Handle download for Android and iOS
        ...
        Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () {
                setState(() {
                  currentIndex = (currentIndex - 1 + widget.imagesList.length) %
