    ...
    return Row(
      ...
      children: [
        Expanded(
          child: Container(
              padding:
                  const EdgeInsets.only(left: 5, right: 1, top: 2, bottom: 2),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(msgContainerBorderRadius),
              ),
              child: widget._isOurMessage
                  ? Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          decoration: BoxDecoration(
                            color: themeColorContainer, //Color(0xFF1B97F3),
                          ...
                          child: Padding(
                            ...
                            child: Text(widget._message.message!,
                                style: TextStyle(
                        ...
                        Text(
                          DateFormat('jm').format(widget._message.timestamp!),
